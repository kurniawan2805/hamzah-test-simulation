...
1. Buat aplikasi Clerk, lalu aktifkan integrasi **Connect with Supabase**. Token sesi harus mempunyai claim `role: authenticated`.
2. Buat proyek Supabase dan tambahkan Clerk pada **Authentication → Third-Party Auth**.
